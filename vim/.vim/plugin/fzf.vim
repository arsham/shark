...
if has('nvim')
    command! -bang -nargs=? -complete=dir Files
        \ call fzf#vim#files(<q-args>, {'options': ['--layout=reverse', '--info=inline', '--preview', '~/.vim/plugged/nvim/fzf.vim/bin/preview.sh {}']}, <bang>0)
else
    command! -bang -nargs=? -complete=dir Files
        \ call fzf#vim#files(<q-args>, {'options': ['--layout=reverse', '--info=inline', '--preview', '~/.vim/plugged/vim/fzf.vim/bin/preview.sh {}']}, <bang>0)
endif
