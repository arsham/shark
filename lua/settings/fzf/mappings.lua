...
util.inoremap({ "<c-x><c-k>",
  [[fzf#vim#complete('cat /usr/share/dict/words-insane')]],
  expr = true, desc = "dict completion",
})
...
end, desc = desc .. " (ignore .gitignore)" })
