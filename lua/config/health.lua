...
local file_checks = {
  ...
  ["Words dictionary"] = { "/usr/share/dict/words-insane", { "yay|paru -S words-insane" } },
}

local executables = {
  bat = { "bat", "yay|paru -S bat" },
  buf = { "buf", "Update Mason" },
  ctags = { "ctags", "yay|paru -S ctags" },
  diagon = { "diagon", "yay|paru -S diagon-git" },
  fd = { "fd", "yay|paru -S fd" },
  fixjson = { "fixjson", "Update Mason" },
  fzf = { "fzf", "yay|paru -S fzf" },
  git = { "git", "yay|paru -S git" },
  golangci = { "golangci-lint", "Update Mason" },
  prettier = { "prettier", "Update Mason" },
  ["Python-pip"] = { "pip3", "yay|paru -S python-pip" },
  ripgrep = { "rg", "yay|paru -S rg" },
  selene = { "selene", "Update Mason" },
  stylua = { "stylua", "Update Mason" },
  TheSilverSearcher = { "ag", "yay|paru -S the_silver_searcher" },
  tmux = { "tmux", "yay|paru -S tmux" },
  tmuxp = { "tmuxp", "yay|paru -S tmuxp" },
  uncrustify = { "uncrustify", "yay|paru -S uncrustify" },
}
